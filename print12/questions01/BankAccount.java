...
public class BankAccount {
	...
	public static void transfer(BankAccount b1,BankAccount b2,int money) {
		if(BankAccount.chkMoney(b1, money)) {
			b1.withdraw(money);
			b2.deposit(money);
			System.out.println(b1.getName() + "から" + b2.getName() + "へ" + money + "円送金しました");
		}else {
			System.out.println(b1.getName() + "の預金残高が足りませんでした");
		}
	}
	
	public static boolean chkMoney(BankAccount b1,int money) {
...
//	public  boolean chkMoney(int money) {
//		if(getBalance() >= money) {
//			return true;
//		}else {
//			return false;
